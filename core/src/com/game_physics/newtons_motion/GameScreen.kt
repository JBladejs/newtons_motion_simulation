...
class GameScreen(private val game: NewtonGame) : Screen {
    ...
    var thrown = false  //bool stwierdzający czy kula ma sie przemieszczac czy nie
    ...
    private fun update() {
        ...
        if (Gdx.input.isKeyJustPressed(SPACE)) thrown = true
    }

    override fun render(delta: Float) {
        Gdx.gl.glClearColor(0f, 0f, 0f, 1f)
        Gdx.gl.glClear(GL20.GL_COLOR_BUFFER_BIT)
        movingObject.render(game.renderer,thrown)
        update()
    }
